...
export default function DevelopementPublicSection() {
  ...
  return (
    <div className="mx-auto  max-w-[89rem] sm:px-6 lg:px-8">
      <div className="relative isolate overflow-hidden bg-neutral-900 px-6 py-20 sm:rounded-3xl sm:px-10 sm:py-24 lg:py-24">
